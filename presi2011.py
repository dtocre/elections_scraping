...
driver.get('https://www.web.onpe.gob.pe/modElecciones/elecciones/elecciones2011/1ravuelta/')

data=[]
writer = codecs.open('elecciones_generales_2011.csv', 'w', "utf-8-sig")

driver.switch_to.frame(driver.find_element_by_xpath('//*[@id="frmset"]/frame[1]'))

resultados = driver.find_element_by_xpath('//*[@id="sub1"]/font/a[1]')
    ...
    for p in range(1,num_provs):
        ...
        for di in range(1,num_dists):
            ...
            for o in range(2,16):
                ...
                try:
                    if o==14 or o==15:
                        organizacion = driver.find_element_by_xpath('/html/body/form[1]/table[2]/tbody/tr[{0}]/td[1]/span'.format(o)).text
                        votos = driver.find_element_by_xpath('/html/body/form[1]/table[2]/tbody/tr[{0}]/td[2]/div/span'.format(o)).text
                        validos = ''
                        emitidos = driver.find_element_by_xpath('/html/body/form[1]/table[2]/tbody/tr[{0}]/td[4]/div/span'.format(o)).text
                    else:
                        organizacion = driver.find_element_by_xpath('/html/body/form[1]/table[2]/tbody/tr[{0}]/td[3]/span'.format(o)).text
                        votos = driver.find_element_by_xpath('/html/body/form[1]/table[2]/tbody/tr[{0}]/td[4]/div/span'.format(o)).text
                        validos = driver.find_element_by_xpath('/html/body/form[1]/table[2]/tbody/tr[{0}]/td[5]/div/span'.format(o)).text
                        emitidos = driver.find_element_by_xpath('/html/body/form[1]/table[2]/tbody/tr[{0}]/td[6]/div/span'.format(o)).text
                ...
                df.to_csv('elecciones_generales_2011.csv', index=False, encoding='utf-8-sig')
